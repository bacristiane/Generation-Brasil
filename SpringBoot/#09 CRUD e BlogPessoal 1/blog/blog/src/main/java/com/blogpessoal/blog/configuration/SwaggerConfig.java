package com.blogpessoal.blog.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.blogpessoal.blog.controladores"))
	...
	private static Contact contact() {
		return new Contact("Bárbara Cristiane", "https://github.com/bacristiane/Generation-Brasil/tree/master/SpringBoot/%2309%20CRUD%20e%20BlogPessoal%201/blog/blog", "barbara.cristianefs@gmail.com");
	}
